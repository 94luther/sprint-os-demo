...
(function (root) {
  ...
  /* THE VEHICLES, ONE LIST. It used to live inside apps/fleet/index.html, so the
     home page could not count them and honestly reported that it did not know how
     many were moving. A fact that one page owns and another page needs is the same
